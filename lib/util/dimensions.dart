...
extension Dimension on double {
  ...
  // }
  double get dynamicH => Platform.isAndroid ? h : this;

  double get dynamicW => Platform.isAndroid ? w : this;

  double get dynamicSP => Platform.isAndroid ? sp : this;

  double get dynamicR => Platform.isAndroid ? r : this;
}
...
class Dimensions {
  ...
  static double w109 = 109.0.dynamicW;
  ...
  static double w142 = 142.0.dynamicW;
  static double w143 = 143.0.dynamicW;
  ...
  static double h109 = 109.0.dynamicH;
  ...
  static double h145 = 145.0.dynamicH;
  ...
  static double h250 = 250.0.dynamicH;
